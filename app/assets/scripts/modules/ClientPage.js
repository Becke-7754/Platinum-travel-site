...
class ClientPage {
  ...
  sendRequest() {
    Axios.post(
      "https://kind-turing-bb9aa1.netlify.app/.netlify/functions/secret-page",
      ...
      .catch(() => {
        this.contentArea.innerHTML = `<p class="client-area__error"> Таны оруулсан нууц үг буруу байна. Дахин оролдно уу </p> `;
        this.field.value = "";
        this.field.focus();
      });
  }
